...
namespace ReVerso.Data
{
    ...
    public class PatientDataManager : MonoBehaviour
    {
        ...
        /// Sur Android (Quest), streamingAssetsPath est en lecture seule (dans l'APK).
        /// On utilise persistentDataPath qui est accessible en écriture.
        /// </summary>
        private void InitializeSavePath()
        {
            // persistentDataPath est writable sur toutes les plateformes (Android, PC, etc.)
